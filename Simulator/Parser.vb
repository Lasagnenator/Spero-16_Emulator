Public Class Parser
    Public Shared Function Parse(Code As String) As UInt16()
        ...
        For i = 0 To (Code.Length \ 4) - 1
            ...
            'Array.Copy(Code.ToArray(), i * 4, CodeArr, i, 4)
        Next
        ...
        'Dim temp = CodeArr.ToList().ConvertAll(Of UInt16)(Function(x) Convert.ToUInt16(CInt("&H" & x)))
        'Array.Copy(Code.ToCharArray(), Arr, 4)
